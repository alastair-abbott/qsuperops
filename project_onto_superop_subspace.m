function W_projected = project_onto_superop_subspace(W, dims_raw, parties_raw, superop_class)
%project_onto_superop_subspace Projects a superoperator onto a subspace of valid superoperators
%   W_projected = project_onto_superop_subspace(W, dims, parties, superop_class)
...
% Written by Alastair Abbott (2022), last modified 20 September 2022
    ...
    %% Apply to projector for the corresponding superoperator class
    switch superop_class
        case 'GEN'
            W_projected = valid_superop_projection;
        otherwise
            error('Error: Unknown superoperator class');
    end
    
    % Put W back in its original ordering
    W_projected = superop_from_canonical_ordering(W_projected,dims_raw,parties_raw);

    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %% PROJECTIONS FOR DIFFERENT SUBSPACES
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

    %% %%%%%%%%%%%%%%%% Valid superops (full set of process matrices) %%%%%%%%%%%%%%%%
    function W_proj = valid_superop_projection
        % Implemented separately and explicitly for each N
        switch N
            case 1
                %%
                P = 1;
